...
//     position: [118.53728, 31.603038121, 70.4],
//     style: {
//       label: {
//         text: "沉降传感器",
//         font_size: 18
...
//     },
//     attr: { cgq: "4号", weizhi: "黄梅山保通线JK44+135-JK44+245", cgqlx: "沉降器传感器2", cgqqx: "hmscjcgq" },
...
//   const graphic = new mars3d.graphic.DivLightPoint({
//     position: [118.537368, 31.603038121, 70.4],
//     style: {
//       label: {
//         text: "沉降传感器",
//         font_size: 18
...
//   const graphic = new mars3d.graphic.DivLightPoint({
//     position: [118.53744, 31.603351121, 70.4],
//     style: {
//       label: {
//         text: "沉降传感器",
//         font_size: 1
...
//       heightReference: Cesium.HeightReference.CLAMP_TO_GROUND
//     },
//     attr: { cgq: "2号", weizhi: "黄梅山保通线JK44+135-JK44+245", cgqlx: "水平位移传感器", cgqqx: "hmsspwycgq" },
...
//   const graphic = new mars3d.graphic.DivLightPoint({
//     position: [118.53717, 31.603038121, 70.4],
//     style: {
//       label: {
//         text: "沉降传感器",
//         font_size: 1
...
//       heightReference: Cesium.HeightReference.CLAMP_TO_GROUND
//     },
//     attr: { cgq: "5号", weizhi: "黄梅山保通线JK44+135-JK44+245", cgqlx: "水平位移传感器2", cgqqx: "hmsspwycgq2" },
...
//   const graphic = new mars3d.graphic.DivLightPoint({
//     position: [118.53753, 31.603038121, 70.4],
//     style: {
//       label: {
//         text: "沉降传感器",
//         font_size: 1
...
//       heightReference: Cesium.HeightReference.CLAMP_TO_GROUND
//     },
//     attr: { cgq: "3号", weizhi: "黄梅山保通线JK44+135-JK44+245", cgqlx: "测斜传感器", cgqqx: "hmsspwycgq" },
...
//   const graphic = new mars3d.graphic.DivLightPoint({
//     position: [118.53751, 31.60288121, 70.4],
//     style: {
//       label: {
//         text: "土压力盒1",
//         font_size: 1
...
//       heightReference: Cesium.HeightReference.CLAMP_TO_GROUND
//     },
//     attr: { cgq: "6号", weizhi: "黄梅山保通线JK44+135-JK44+245", cgqlx: "土压力盒1", cgqqx: "hmsspwycgq" },
...
//   const graphic = new mars3d.graphic.DivLightPoint({
//     position: [118.53741, 31.60288121, 70.4],
//     style: {
//       label: {
//         text: "土压力盒2",
//         font_size: 1
...
//       heightReference: Cesium.HeightReference.CLAMP_TO_GROUND
//     },
//     attr: { cgq: "7号", weizhi: "黄梅山保通线JK44+135-JK44+245", cgqlx: "土压力盒2", cgqqx: "hmsspwycgq" },
...
//   const graphic = new mars3d.graphic.DivLightPoint({
//     position: [118.53731, 31.60286121, 70.4],
//     style: {
//       label: {
//         text: "土压力盒3",
//         font_size: 1
...
//       heightReference: Cesium.HeightReference.CLAMP_TO_GROUND
//     },
//     attr: { cgq: "8号", weizhi: "黄梅山保通线JK44+135-JK44+245", cgqlx: "土压力盒3", cgqqx: "hmsspwycgq" },
...
export function flyToGraphic(item) {
  ...
  map.flyToPoint(graphic.position, { pitch: -40, radius: 119, heading: -20, roll: 90 })
}
