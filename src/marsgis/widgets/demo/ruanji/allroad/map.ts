...
function add1(graphicLayer) {
  const graphic = new mars3d.graphic.PointEntity({
    position: [118.541576, 31.605121, 1000000],
    style: {
      width: 8,
      clampToGround: true,
      color: "rgb(0,191,255)"
    ...
    name: "钟山排土场",
    show: false,
    attr: { xuhao: 1, zong: "-16.2mm", bannian: "-8.3mm", name: "钟山排土场", beizhu: "该处沉降较缓", options: { pitch: -83 } }
  })
...
//       { xuhao: 2, zong: "-16.2mm", bannian: "-8.3mm", beizhu: "沉降较缓", name: "k31+000~k31+500" },
